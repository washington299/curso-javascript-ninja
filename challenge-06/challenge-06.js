...
desafio.
*/
var teams = ['Palmeiras', 'São Paulo', 'Santos', 'Corinthians', 'Agua Santa'];
...
function convertToHex(color) {
  ...
  switch(color) {
    case "white":
      console.log('O hexadecimal para a cor ' + color + ' é ' + white + '.');
      break;
    case "black":
    ...
    case "red":
      ...
      break;
    case "green":
      console.log('O hexadecimal para a cor ' + color + ' é ' + green + '.');
      break;
    case "pink":
