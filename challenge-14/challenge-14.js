(function() {
  ...
  */
  console.log( '\nJust Numbers:' );
  var justNumbers = numberObjects.map(function(element) {
  ...
  */
  console.log( '\nOperation 2:' );
  var operation2 = justMod20r3.reduceRight(function(acumulado, atual) {
    return (acumulado + 1) * atual;
  }, 0);
  ...
  */
  ...
  console.log('O objeto não existe pois ele foi criado no momento da comparação; logo, é uma nova referência em memória, diferente da referência que está no objeto atribuído à numberObjects.');
  ...
  */
  ...
  console.log(Array.isArray(justMod20r3) ? justMod20r3.toString() : '');
})()
